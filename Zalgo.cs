...
namespace Zalgo {
    class Zalgo {
        ...
        public static ushort[] ZalgoDown = {
        ...
        public static string GenerateZalgoString(string originalStr, bool zalgoUp, bool zalgoMid, bool zalgoDown, bool ignoreZalgoChars, ushort zalgoRate) {
            string ret = "";
